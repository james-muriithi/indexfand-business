    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sender_name') ? 'is-invalid' : '' }}" type="text" name="sender_name" id="sender_name" value="{{ old('sender_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sender_contact') ? 'is-invalid' : '' }}" type="text" name="sender_contact" id="sender_contact" value="{{ old('sender_contact', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receiver') ? 'is-invalid' : '' }}" type="text" name="receiver" id="receiver" value="{{ old('receiver', '') }}">
