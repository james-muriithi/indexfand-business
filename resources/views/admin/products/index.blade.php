...
@section('scripts')
    ...
    <script>
        $(function () {
            let buttons = ['csv', 'pdf', 'Delete selected','selectAll', 'selectNone'];

            buttons = $.fn.dataTable.defaults.buttons.filter(item => buttons.includes(item.extend))

            let dtButtons = $.extend(true, [], buttons)
